export const color = {
  ...
  green: "#9AF2BE",
  primaryGradient:
    "linear-gradient(0deg, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.05)), #22356a",
  primaryGradientDark:
    "linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), #22356a",
  greenGradient: "linear-gradient(97.49deg, #A3FFC8 2.19%, #71FFE5 104.79%)",
  disabledColor: "#5F6995", // button backgorund and button border
};
